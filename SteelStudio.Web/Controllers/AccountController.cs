...
namespace SteelStudio.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    return RedirectToAction("Index", "Products");// ir a vista global de contenidos
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]        
        public async Task<ActionResult> Register(RegisterViewModel model, FormCollection result)
        {
            if (ModelState.IsValid)
            {
                ...
                if (create.Succeeded)
                {
                    switch (result["Permiso"])
                    {
                        ...
                        case "Disenador":
                            {
                                UserManager.AddToRole(user.Id, "diseñador");                                
                                break;
                            }                        
                        default:
                            break;
